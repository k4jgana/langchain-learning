...
from makeshift_agent.callbacks import AgentCallbackHandler

load_dotenv()

@tool
def get_text_length(text:str)-> int:
    """returns length of characters in string"""
...
if __name__== "__main__":
    ...
    print(get_text_length.invoke(input = {'text':'lamarina'}))
    template = """
    ...
    while not isinstance(agent_step, AgentFinish):
        agent_step : Union[AgentAction, AgentFinish] =\
            agent.invoke({'input': "What is the length of 'lamarina' in characters",
